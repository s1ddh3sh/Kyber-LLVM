...
void kyber_shake128_absorb(keccak_state *state,
  ...
  PRINT_ARGS("kyber_shake128_absorb", "state", state, seed, x, y);
}
...
void kyber_shake256_prf(uint8_t *out, size_t outlen,
  ...
  PRINT_ARGS("kyber_shake256_prf", "out", out, outlen, key, nonce);
}
...
void kyber_shake256_rkprf(uint8_t out[KYBER_SSBYTES],
  ...
  PRINT_ARGS("kyber_shake256_rkprf", "out", out, key, input);
}
